...
# Calculate KPIs
average_sleep_quality = round(df_select['Sleep Quality'].mean(), 1)
sleep_duration = round(df_select['Sleep Duration'].mean(), 1)
average_steps = round(df_select['Daily Steps'].mean(), 1)

first_column, second_column, third_column = st.columns(3)

with first_column:
    st.subheader("Average sleep quality")
...
with third_column:
    st.subheader("Average daily steps:")
